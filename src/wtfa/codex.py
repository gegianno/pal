...
def run_interactive(workspace_dir: Path, codex_cfg: CodexConfig) -> None:
    subprocess.run(codex_cmd(workspace_dir, non_interactive=False, codex=codex_cfg), check=True)
